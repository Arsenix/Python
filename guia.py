...
#Ejercicio 4
if = int(input("Ingrese el numero a calcular su factorial: "))
if f > 1:
	f*=f-1
...
if (cht >= 3):
	...
	if (vsp > vnb):
		print "Es más conveniente comprar en el negocio del barrio, se gastara un total de :",vnb," el ahorro total es de :",vnb-vsp," cada uno debe aportar: " (float(vnb)/float(cp)
	elif (vsp<vnb):
		print "Es más conveniente comprar en el supermercado, se gastara un total de :",vsp, "el ahorro total es de :",vsp-vnb," cada uno debe aportar: " (float(vsp)/float(cp)
	else:
